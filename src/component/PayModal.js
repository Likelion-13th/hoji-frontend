        ...
        <div className='modal'>
            ...
            <div className='container'>
                ...
                <div className='section'>
                    ...
                    <div className='order-info'>
                        ...
                        <div>
                            ...
                            <div className='order-price'>{product.price.toLocaleString()}</div>
                ...
                <div className='section'>
                    ...
                    <div className='user-info'>호지</div>
                    <div className='user-info'>010-9107-1653</div>
                    <div className='user-info'>집</div>
                </div>
                <div className='section'>
                    <div className='section-title'>마일리지</div>
                    <div className='mileage-info'>현재 사용 가능한 마일리지: {maxMileage.toLocaleString()} 원</div>
                    <input
